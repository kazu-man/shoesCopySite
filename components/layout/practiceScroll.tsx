...
export default function mainContentLayout({ children }: mainContentProps) {
  ...
  useLayoutEffect(() => {
    ...
    tl
      ...
      .to('.slide1', { x: -100 })
      //   .from('.slide1', { x: -100 })
      //   .to('.rotate', { rotation: 100 })
      //   .addLabel('color')
      .to('.slide2', { backgroundColor: '#28a92b', xPercent: -100 })
      //   .addLabel('spin')
  ...
  return (
    <>
      <div id='container' className='relative'>
        ...
        >
          {/* <div
            className='rotate absolute h-full w-full bg-green-50'
            style={{ height: '300vh' }}
          >
            ROTATE
          </div> */}
          ...
          >
            ...
            >
              ...
              <div className='insideContainer'>
                <div className='inside bg-red-50'>INSIDE CONTAINER</div>
              </div>
            </section>
          </section>
        </section>
